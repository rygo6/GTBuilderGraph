...
{
    public class CurveSweepNode : BuilderNode
    {
#if UNITY_EDITOR
        [SerializeField]
        ...
        [SerializeField]
        private MeshEvent _meshGenerated;

        [SerializeField]
        private MeshGroupEvent _meshGroupGenerated;

        private MeshGroup _meshGroup = new MeshGroup();

        public List<Vertex> RailPoints
        {
            get { return _railPoints; }
            set
            {
                _railPoints = value;
        ...
        public List<VertexGroup> PathVertexGroups
        {
            get { return _pathVertexGroups; }
            set
            {

                _pathVertexGroups = value;
                GenerateMesh();
            }
        }
        ...
        public List<Vertex> PathPoints
        {
            set
            {
                ...
                _pathVertexGroups.Add(new VertexGroup(value));
                GenerateMesh();
            }
        }
        ...
        private void GenerateMesh()
        {
            if (_pathVertexGroups != null)
            {
                ...
                _meshGroupGenerated.Invoke(_meshGroup);
                _meshGenerated.Invoke(_meshGroup.Meshes[0]);
            }
        }
        ...
        private void GenerateMesh(VertexGroup vertexGroup)
        {
            ...
            for (int p = 0; p < vertexGroup.Vertices.Count; ++p)
            {
                ...
                Quaternion lookRotation = Quaternion.LookRotation(vertexGroup.Vertices[p].Tangent, vertexGroup.Vertices[p].Normal);
